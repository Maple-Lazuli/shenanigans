...
python lenet_satsim_graph.py --config_json ./exe_configs/satsim_config_1_example.json --epochs 4
python evaluate.py --config_json s./exe_configs/atsim_config_1_example.json
python lenet_satsim_graph.py --config_json ./exe_configs/satsim_config.json --epochs 4
